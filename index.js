 ...
 */
export default function(domNode, className, timeout = MAX_TIMEOUT) {
    return new Promise((resolve, reject) => {
        ...
        let timeoutId = setTimeout(() => {
            ...
            console.error(`Timeout occured before animation completed: ${className}`);
        ...
        domNode.addEventListener("animationend", () => {
            // timeout occured before animation completed
            if (resolved) {
                return;
            }
